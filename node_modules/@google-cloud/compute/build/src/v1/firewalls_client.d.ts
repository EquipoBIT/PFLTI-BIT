...
export declare class FirewallsClient {
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is Array of [Firewall]{@link google.cloud.compute.v1.Firewall}.
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing [Firewall]{@link google.cloud.compute.v1.Firewall} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     ...
     *   [Firewall]{@link google.cloud.compute.v1.Firewall}. The API will be called under the hood as needed, once per the page,
